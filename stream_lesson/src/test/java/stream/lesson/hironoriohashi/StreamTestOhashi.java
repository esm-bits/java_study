package stream.lesson.hironoriohashi;
...
import stream.lesson.hironoriohashi.StreamTestOhashi.Employee.Sex;

public class StreamTestOhashi {
    ...
    public void 男性社員と女性社員の平均年齢を算出() throws Exception {
        ...
        Map<Sex, Double> averages = employees.stream()
                .collect(groupingBy(Employee::getSex, averagingDouble(Employee::getAge)))
                // あれやこれや
                ;
